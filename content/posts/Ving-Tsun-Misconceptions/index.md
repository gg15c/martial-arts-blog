---
title: "詠春迷思 — Ving Tsun Misconceptions"
slug: "ving-tsun-misconceptions"
date: 2025-02-15
...
The section "Ving Tsun Misconceptions" in each issue of Real Ving Tsun Kung Fu will be a forum to discuss topics and principles that are commonly misunderstood and have a negative impact on the style overall.

A lack of realistic and pragmatic thinking frequently renders otherwise effective Ving Tsun techniques useless. Throughout my seminar teachings, I have consistently pointed out the simplicity of our style. This simplicity made it possible that Ving Tsun developed into one of the most effective fighting styles of the Chinese kung fu system.

在《真實詠春》雜誌的「詠春迷思」專欄裡，我們會討論那些常被誤解、對詠春整體造成負面影響的觀念與原則。缺乏務實的思考，經常讓原本有效的詠春技巧變得毫無用處。在我的研討會上，我一直不斷強調我們這門拳術的「簡單」。正是這份簡單，讓詠春發展成中國功夫體系中最具實戰性的拳術之一。

> **Unbridled imagination is the biggest enemy of Ving Tsun.** It can lead us into the land of make believe — and this to a degree only seen in other styles until now.

> **天馬行空的幻想是詠春最大的敵人。** 它會把我們帶入夢幻世界——而且嚴重到以前只會在其他門派才看得到的程度。
...
The centerline punch, for instance, simultaneously attacks and protects the centerline, as each action should guard one's own head.

比如中線日字衝拳，既攻擊又保護中線，每一個動作都該護住自己的頭。

### 正面進攻的優勢

The type of frontal attack that is typical of Ving Tsun:

| 優勢 | Advantage |
|------|-----------|
| **保護攻擊者** | Provides protection for the attacker |
| **雙手平衡** | Evens out the reach and impact of both arms |
| **穩定性** | Maintains stability |

This is in contrast to elaborate body rotation maneuvers that lead to instability and loss of power.

這跟那些花哨的轉身動作完全不同，那種動作只會讓你不穩、洩力。

### 詠春轉馬的三個目的

In Ving Tsun we only pivot for three reasons:

| 目的 | Purpose |
|------|---------|
| **卸開攻擊** | Deflect an attack |
| **向前逼近** | Gain ground on the opponent |
| **重新對準** | Reorient towards the other combatant |

在詠春裡，我們轉馬只有三個目的：卸開攻擊、向前逼近對手，或是重新對準對手。
...
> 當然啦，這招管用——但前提是你的對手腦袋不太靈光、根本不是真的想打你、或者只出了一拳。
...
Of course it looks great: one fighter slams his punch at full speed into the mostly extended arm of the defender, the impact transforms the defender's arm into a Bong Sau as he pivots off to the side and moves his weight to his rear leg.

The attacker is unable to react and stumbles past his target.

當然場面看起來很帥：一個人全速出拳打在防守者伸直的手臂上，衝擊力讓防守者的手臂變成膀手，他順勢側身轉馬、重心移到後腳。攻擊者來不及反應，踉蹌撲空。

> **Looks great and practically sells itself!** But it only works in prearranged demonstrations and if my opponent is not only very strong but also exceptionally stupid.

> **看起來很漂亮，根本不用說！** 但這只在套招示範，或者對手力氣很大但「特別蠢」的時候才管用。

---

## 更貼近現實的場景

Here's a more realistic scenario: my opponent is quite sure that he will defeat me (hence his attack) and naturally wants to reach his target.

來看一個更貼近現實的場景：對手深信自己能打敗你（不然他幹嘛出手），而且一心想打中目標。
...
對手已經搶到大量空間，正瞄準你打下一拳——而你快速的左右移動產生的離心力正在把你甩得東倒西歪。你的防禦動作失去了穩固的根基，變得毫無效果。
...
> Such a significant shift in the center of gravity necessarily leads to another similarly sizable shift in body weight that yields more territory to my opponent and makes my own position even more unstable. **This is a recipe for disaster.**

> 重心的大幅偏移必然導致另一次同樣劇烈的重心轉換，你會拱手讓出更多空間，自己的位置變得更不穩。**這是個災難。**

There are many reasons why moving your own centerline back and forth makes no sense:
...
When practicing with focus mitts we also prepare for the reality that our opponent does not want to be hit and will try to evade our action and maneuver into a better position.

我們練手靶時也要面對現實：對手不想被打中，他們會閃躲並試圖佔據更好的位置。

Using skillful pursuit techniques we try to:

| 目標 | Goal |
|------|------|
| **壓縮對手空間** | Gain ground on the practice partner |
| **削減反擊能力** | Reduce his ability to counterattack |
...
There are arrogant Ving Tsun practitioners who mimic the "stupid karate guy" who attacks from a low stance, kata-style, or exposes his groin to attack while delivering a high kick.

有些傲慢的詠春練習者喜歡模仿「笨笨的空手道傢伙」用低姿勢、套路式的攻擊，或者踢高腿時露出下襠的破綻。
...
> 一個踢頭或一腳低掃打在小腿上，就全線崩潰。那些被他們貶低為「不合邏輯」、有時甚至被輕蔑地稱為「只是運動」的格鬥方式，卻能把詠春世界攪得天翻地覆，這實在太荒謬了。

---

## 故弄玄虛的溫床

This is why there have been many attempts to **infuse principles of other systems into Ving Tsun**.

正因如此，很多人開始試圖把其他門派的原理硬塞進詠春裡。

Profound doubts about one's own system also lead to:
...
> **詠春的力量在於簡單與務實。一旦脫離核心原則，再花哨的技巧都毫無意義。**
